...
for i in range(1, 18):
    ...
    if i < 10:
        ...
        subject = 'sub0' + str(i)
    fmrifiles = list(filter(None, os.popen('find ' + subject + '/task001*/ba_avg_intensity/ -name "*.pkl.bz2"').read().split('\n')))
    ...
    outfile = '/gpfs/hpchome/gagand87/project/Data/processed_data/avg_per_sub/' + subject + '_avg_areas_task1.pkl.bz2'
    mean_dict = {}
